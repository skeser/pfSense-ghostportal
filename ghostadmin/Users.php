            ...
            <tr>
                ...
                <td>
                    ...
                    <div id="content-table-inner">
                            ...
                            <form id="mainform" action="">
                                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="table-header-repeat line-left minwidth-1">><a href="">TC KİMLİK</a>
                                        </th>
                                    ...
                                    while ($goster = mysqli_fetch_array($bul)) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="options-width">
                                                <a href="Users.php?id=Useredit&edit=<?php echo "{$id}"; ?>"
                                                   title="Düzenle" class="icon-1 info-tooltip"></a>
                                                <a href="Users.php?id=Delete&sil=<?php echo "{$id}"; ?>" title="Sil"
                        ...
                        <div id="actions-box">
                            <a href="Save.php?id=Ghostclear" title="Bütün Logları temizler"
            ...
            <tr>
                ...
                <td>
                    ...
                    <div id="content-table-inner">
                            ...
                            <form id="mainform" action="">
                                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="table-header-repeat line-left minwidth-1"><a href="">DOĞUM TARİHİ</a>
                                        </th>
                        ...
                        <div id="actions-box">
                            <a href="Save.php?id=cleartc" title="Bütün Logları temizler"
                               onClick="return confirm('Bütün logları temizlemekten eminmisin ?')"><img
                                    src="images/sil.png" width="32" height="32"/> </a>
                            <div class="clear"></div>
                        </div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div id="content-table-inner">
                        ...
                        <div id="actions-box">
                            <a href="Save.php?id=smsclear" title="Bütün Logları temizler"
                               onClick="return confirm('Bütün logları temizlemekten eminmisin ?')"><img
                                    src="images/sil.png" width="32" height="32"/> </a>
                            <div class="clear"></div>
                        </div>
                                            ...
                                            <form action="Users.php?id=UserSave&Save=<?= $id; ?>" method="POST">
                                                <table width="600" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="adsoyad" value="<?= $adsoyad; ?>"
                                                                   class="inp-form"/></td>
                                                        <td></td>
                                                    </tr>
